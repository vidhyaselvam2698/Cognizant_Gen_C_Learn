	...
	<center>
		...
		<table>
			...
			<sf:form action="getBMI" modelAttribute="user" method="GET"
				...
				<tr>
					<td>Enter Name:</td>
					<td><sf:input path="name" id="name" name="name" /> <sf:errors
							style="color:red" path="name"></sf:errors></td>
				</tr>
				<tr>
					<td>Phone Number:</td>
					<td><sf:input path="phoneNumber" id="phoneNumber"
							name="phoneNumber" /> <sf:errors style="color:red"
							path="phoneNumber"></sf:errors></td>
				</tr>
				<tr>
					<td>Height in CM:</td>
					<td><sf:input path="height" id="height" name="height" /> <sf:errors
							style="color:red" path="height"></sf:errors></td>
				</tr>

				<tr>
					<td>Weight in KG:</td>
					<td><sf:input path="weight" id="weight" name="weight" /> <sf:errors
							style="color:red" path="weight"></sf:errors></td>
				</tr>
